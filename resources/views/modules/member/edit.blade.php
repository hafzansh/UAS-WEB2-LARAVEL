...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="card-header"><i class="fas fa-table mr-1"></i>Edit Data Member</div>
                <div class="card-body">
                <form method="POST" action="{{ route('members.update', $member->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control py-4" id="tanggal_lahir" value="{{ $member ? $member->tanggal_lahir : '' }}" type="date" placeholder="Masukkan Tanggal Lahir" name="tanggal_lahir" required />
                    </div>
