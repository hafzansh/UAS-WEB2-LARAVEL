            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="float-left">
                        <span class="align-middle" style="font-size: 25px;"><i class="fas fa-book mr-1"></i>&nbsp;Data Transaksi</span>
                    </div>
                    <div class="float-right">
                        <a href="{{ route('transaction.create') }}" class="btn btn-xs btn-primary">Pinjam Buku</a>
                        <a href="{{ route('transaction.index') }}" class="btn btn-xs btn-info">Pengembalian Buku</a>
